...
const SubrecordActiveHeadersSearch: React.FC<Props> = ({
  fields,
  searchFields,
  setSearchFields,
}) => {
  return (
    <div className="mb-3 p-3 bg-dark rounded-2 text-light border border-secondary">
      <div className="mb-2 fw-bold">
        Buscar nos campos visíveis (Subregistros):
      </div>
      <div className="d-flex flex-wrap gap-2 align-items-end">
        {fields
          ...
          .map((field) => {
            ...
            const isBoolean = type === "check" || type === "checkbox";
...
export default SubrecordActiveHeadersSearch;
